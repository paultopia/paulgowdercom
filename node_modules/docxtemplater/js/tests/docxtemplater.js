...
var fileNames = ["angularExample.docx", "cyrillic.docx", "imageExample.docx", "tableComplex2Example.docx", "tableComplexExample.docx", "tagDashLoop.docx", "tagDashLoopList.docx", "tagDashLoopTable.docx", "tagExample.docx", "tagExampleExpected.docx", "tagIntelligentLoopTable.docx", "tagIntelligentLoopTableExpected.docx", "tagLoopExample.docx", "tagProduitLoop.docx"];
	...
	describe("DocxGenLoading", function () {
		...
		describe("basic loading", function () {
			it("should load file imageExample.docx", function () {
				expect(_typeof(docX["imageExample.docx"])).to.be.equal("object");
			});
		});
...
var endLoadFile = function endLoadFile(change) {
	change = change || 0;
	countFiles += change;
